<template>
  <Slider
    imageUrl="https://aganlar.com/Content/Themes/images/about-banner.png"
  />
          ...
          <div class="posts">
            <a
              ...
              :style="[
                owner.imgUrl !== ''
                  ? {
                      'background-image': 'url(' + owner.imageUrl + ')',
                    }
                  : { background: 'url(img/yat.jpg) center no-repeat' },
              ]"
            >
              <div class="tour_item_bottom">
                <h3 class="_title">{{ owner.name }}</h3>
                <div class="_info">
                  <div class="_info_left">
                    <div class="cost">{{ owner.position }}</div>
                  </div>
                </div>
              </div>
            </a>
            ...
            <div class="gallery-list">
              ...
              <a href="gallery-single.html" class="gallery-item">
                ...
                <div class="images">
                  <div class="scroll">
                    <div class="img">
                      <img src="img/gal-2-2.jpg" alt="" />
                    </div>
                    <div class="img">
                      <img src="img/gal-2-1.jpg" alt="" />
                    </div>
                    <div class="img">
                      <img src="img/gal-2-2.jpg" alt="" />
                    </div>
...
export default {
  ...
  data() {
    return {
      ...
      stuffImages: [
        "https://www.aganlar.com/Admin/Content/Photos/Gallery/3042019164335-img_4753.png",
        "https://www.aganlar.com/Admin/Content/Photos/Gallery/3042019170013-img_8756.png",
        "https://www.aganlar.com/Admin/Content/Photos/Gallery/3042019164537-img_4790.png",
        "https://www.aganlar.com/Admin/Content/Photos/Gallery/3042019170025-img_8757.png",
        "https://www.aganlar.com/Admin/Content/Photos/Gallery/3042019164607-img_4811.png",
        "https://www.aganlar.com/Admin/Content/Photos/Gallery/3042019164628-img_4851.png",
        "https://www.aganlar.com/Admin/Content/Photos/Gallery/3042019164817-img_4871.png",
        "https://www.aganlar.com/Admin/Content/Photos/Gallery/3042019165913-img_8505.png",
      ],
    };
  },
};
